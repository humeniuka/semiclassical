...
parser.add_argument(
    ...
    default=4.0,
    metavar='s',
    help='dissociated geometries are generated by scaling the first N geometries in the data set by this factor (default: s=4.0)')
parser.add_argument(
    '--ngeo',
    dest='ngeo',
    type=int,
...
def fix_dissociation_limit(molecules, dissoc_limit=None, scale=4.0, ngeo=1000):
    ...
    print(f"adding first {ngeo} geometries with coordinates scaled by a factor of {scale} and energy=E(dissociation) and forces=0")
    scaled = []
